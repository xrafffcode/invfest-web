<div class="card border-0 card-information" id="detail">
    <div class="card-body p-0">
        <h2 class="text-center bg-secondary px-3 py-5 text-white mb-0 text-uppercase fw-bold">
        ...
        <div class="d-flex twibbon justify-content-between align-items-center bg-primary text-white p-4 gap-5">
            ...
            <div class="information p-4">
                ...
                <p class="info-desc mb-5">Hello Developer Muda, Mari kita berpartisipasi dengan menggunakan Twibon dari kami dengan cara <b>unduh
                    Twibon dibawah</b> ini dan posting di media sosial beserta caption yang sudah disediakan. Jangan lupa
                    <b>tag kami!</b>
                </p>
                <div class="d-flex gap-4">
                    <a href="{{ asset(getWebConfiguration()->twibbon_link) }}" class="btn btn-sm btn-rounded border border-1 border-primary text-white">
                        Unduh Twibbon
                    </a>
                    <a href="{{ asset(getWebConfiguration()->twibbon_link) }}" class="btn btn-sm btn-rounded border border-1 border-primary text-white">
                        Video Tutorial
